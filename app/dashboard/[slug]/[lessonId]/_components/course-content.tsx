...
import { GetLessonContentType } from "@/app/data/course/get-leson-content"
...
export function CourseContent({ data }: iAppProps) {
    ...
    function VideoPlayer({
        ...
        if (!videoUrl) {
            return (
                <div className="aspect-video bg-muted rounded-lg flex flex-col items-center justify-center">
                    <BookIcon className="size-6 text-primary mx-auto mb-4" />
        ...
        return (
            <div className="aspect-video bg-black rounded-full relative overflow-hidden">
                <video
            ...
            <div className="py-4 border-b">
                {
                    data.lessonProgrss.length > 0 ? (
                        ...
                        <Button variant={"outline"} onClick={onSubmit} disabled={pending}>
                            <CheckCircle className="size-4 mr-2 text-green-50" />
                            Mark as Complete
                        </Button>
                    )
                }
