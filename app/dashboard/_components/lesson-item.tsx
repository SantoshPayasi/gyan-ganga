    ...
    return (
        <Link href={`/dashboard/${slug}/${lesson.id}`} className={buttonVariants({
            ...
            className: cn(
                ...
                completed && "bg-green-100 dark:bg-green-300 dark:border-green-700 hover:bg-green-200 dark:hover:bg-green-900/50 text-green-800 dark:text-green-200",
            ...
            <div className="flex items-center gap-2.5 w-full min-w-0">
                ...
                <div className="flex-1 text-left min-w-0">
                    ...
                    {
                        completed && (
                            <p className="text-[10px] text-freen-700 dark:text-green-300 font-medium">
                                Completed
                            </p>
                        )
                    }
